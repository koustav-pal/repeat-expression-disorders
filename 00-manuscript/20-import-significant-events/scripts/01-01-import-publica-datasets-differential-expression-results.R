...
study_specific_results_df <- readRDS(file.path("../13-03-public-data/rdata_files/03-01-01-assembled-contrasts-from-all-study-specific-pairwise-comparisons.rds"))
# ==========================================================================
# Packages and Data
# ==========================================================================
...
replace_feature_ids <- feature_ranges$feature_id[match(study_specific_results_df$feature_ids, feature_ranges$hash_id)]
study_specific_results_df$feature_ids <- replace_feature_ids

saveRDS(object = study_specific_results_df, file = file.path(analysis_save_dir, "01-02-import-public-datasets-differential-expression.rds"))